...
# to get date and time of your system
print(datetime.datetime.now())

# to customize date and time according to your output
print(datetime.datetime(2023,10,24))

print(datetime.datetime.now().strftime("%y"))   #return only YEAR in SHORT FORM
print(datetime.datetime.now().strftime("%Y"))   #return only YEAR in FULL FORMAT
print(datetime.datetime.now().strftime("%m"))   #return only MONTH
print(datetime.datetime.now().strftime("%M"))   #return only minute  
